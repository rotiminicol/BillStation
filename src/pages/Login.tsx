              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={`form-input ${errors.email ? 'border-red-500 error-input' : 'border-gray-300 focus:border-blue-500'}`} 
                    required 
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input 
                      ...
                      className={`form-input pr-12 ${errors.password ? 'border-red-500 error-input' : 'border-gray-300 focus:border-blue-500'}`} 
                      required 
                    />
                    <button 
                      type="button" 
                ...
                <Button 
                  type="submit" 
                  disabled={isLoading || !formData.email || !formData.password || errors.email} 
