                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-blue-700">
                      Your data is protected with bank-level encryption and biometric authentication.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                />
                <Label htmlFor="remember-mobile" className="text-xs text-gray-600">
                  Remember me
                </Label>
              </div>
              <Link 
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 mt-4">
              <div className="flex items-start space-x-2">
                ...
                <div className="space-y-1">
                  <h4 className="text-xs font-medium text-blue-900">Secure Login</h4>
                  <p className="text-xs text-blue-700">
                    Bank-level encryption and biometric authentication.
                  </p>
                </div>
              </div>
            </div>
