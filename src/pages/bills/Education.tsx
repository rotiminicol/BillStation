        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Education Payment</h1>
                <p className="text-gray-600">Pay for exams and educational services</p>
              </div>
            </div>
          </motion.div>
              ...
              <Card className="border-0 shadow-lg bg-white rounded-xl">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-xl">Select Exam Type</CardTitle>
                      <p className="text-gray-600">Choose the examination board</p>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    {examTypes.map((exam) => (
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center space-x-4">
                            <div className={`w-12 h-12 bg-gradient-to-br ${exam.color} rounded-xl flex items-center justify-center text-white text-xl font-bold`}>
                              {exam.logo}
                            </div>
                            <div>
                ...
                <Card className="border-0 shadow-lg bg-white rounded-xl">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-xl">Select Fee Type</CardTitle>
                        <p className="text-gray-600">Choose the service you want to pay for</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
