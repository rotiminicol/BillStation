...
const Landing: React.FC = () => {
  return (
      ...
      {/* Hero Section */}
      <section className="bg-[#2a61de] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-xl font-semibold mb-8">
                Everything you need is just a tap away.
                 ...
                 <Button className="bg-transparent hover:bg-gray-100 p-2">
                   <img src="/appstore.png" alt="App Store" className="h-12 w-36 object-contain" />
                 </Button>
                 <Button className="bg-transparent hover:bg-gray-100 p-2">
                   <img src="/playstore.png" alt="Play Store" className="h-10 w-34 object-contain" />
                 </Button>
               </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center">
                <div className="flex justify-center mb-4">
                  <svg className="w-12 h-12 text-[#2a61de]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold mb-2">Download app</h3>
                <p className="text-gray-600">Download Bill Station App from Apple store</p>
                <p className="text-gray-600">and Google Playstore.</p>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-4">
                  <svg className="w-12 h-12 text-[#2a61de]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Fuel your financial journey, enjoy effortless</p>
       ...
       <section className="py-16 bg-gray-50">
         <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              Bill Station app features designed to<br />
           ...
           <div className="relative">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="text-center">
                  <img src="/logo.png" alt="Bill Station Logo" className="h-40 w-auto mx-auto" />
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-96">
                  ...
                  <div className="flex flex-col justify-center space-y-32">
                      ...
                      <div className="flex justify-end items-start">
                        <svg className="w-12 h-12 text-[#2a61de] flex-shrink-0 mr-4 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <div>
                          <h3 className="text-xl font-semibold mb-2">Bill Payments</h3>
                          <p className="text-gray-600">
                            Settle a wide range of bills,<br />
                            including electricity, rent,<br />
                       ...
                       <div className="flex justify-end items-start">
                         ...
                         <div>
                           ...
                           <p className="text-gray-600">
                             Send and receive money swiftly<br />
                             and securely with our reliable<br />
                       ...
                       <div className="flex justify-end items-start">
                         ...
                         <div>
                           ...
                           <p className="text-gray-600">
                             Trade and exchange different<br />
                  ...
                  <div className="flex flex-col justify-center space-y-32">
                      ...
                      <div className="flex justify-start items-start">
                        <div className="mr-4">
                          ...
                          <p className="text-gray-600">
                            Convert your airtime to cash<br />
                            with a few clicks.
                          </p>
                        </div>
                        <svg className="w-12 h-12 text-[#2a61de] flex-shrink-0 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       ...
                       <div className="flex justify-start items-start">
                         <div className="mr-4">
                           ...
                           <p className="text-gray-600">
                             We provide exclusive flight booking,<br />
                             hotel reservations, and airport<br />
                             transportation services, offering both<br />
                             short- and long-term stay options for<br />
                             a comfortable and convenient travel<br />
                             experience.
                           </p>
                         </div>
                         <svg className="w-12 h-12 text-[#2a61de] flex-shrink-0 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       ...
                       <div className="flex justify-start items-start">
                         <div className="mr-4">
                           ...
                           <p className="text-gray-600">
                             Shop online across borders without<br />
                             limitations, fund your dollar card<br />
                             with naira
                           </p>
                         </div>
                         <svg className="w-12 h-12 text-[#2a61de] flex-shrink-0 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             ...
             <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  <svg className="w-12 h-12 text-[#2a61de] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Highly Secure</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Buy Gift Cards</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Instant Gift Card Sale</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex animate-scroll space-x-12">
                   ...
                   <div className="flex items-center space-x-16 flex-shrink-0">
                     ...
                     <div className="flex-shrink-0">
                       <div className="text-gray-800 font-bold text-4xl">SEPHORA</div>
                     </div>
                     ...
                     <div className="flex-shrink-0 flex items-center space-x-3">
                       ...
                       <span className="text-gray-800 font-semibold text-3xl">iTunes</span>
                     </div>
                     ...
                     <div className="flex-shrink-0 flex items-center space-x-3">
                       <div className="flex">
                         ...
                         <div className="w-10 h-10 bg-yellow-500 rounded-full -ml-4"></div>
                       </div>
                       <span className="text-gray-800 font-semibold text-2xl">mastercard</span>
                     </div>
                     
                     {/* Google Play */}
                     <div className="flex-shrink-0 flex items-center space-x-3">
                       <svg className="w-11 h-11 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                         <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                       </svg>
                       <span className="text-gray-800 font-semibold text-3xl">Google Play</span>
                     </div>
                     
                     {/* eBay */}
                     <div className="flex-shrink-0">
                       <div className="text-gray-800 font-bold text-4xl">ebay</div>
                     </div>
                     ...
                     <div className="flex-shrink-0 flex items-center space-x-3">
                       ...
                       <span className="text-gray-800 font-bold text-3xl">Walmart</span>
                     </div>
                     
                     {/* Amazon */}
                     <div className="flex-shrink-0 flex items-center space-x-3">
                       <span className="text-gray-800 font-bold text-4xl">amazon</span>
                     ...
                     {/* Visa */}
                     <div className="flex-shrink-0">
                       <div className="text-gray-800 font-bold text-4xl">VISA</div>
                     </div>
                     
                     {/* Nordstrom */}
                     <div className="flex-shrink-0">
                       <div className="text-gray-800 font-bold text-4xl">NORDSTROM</div>
                     </div>
                   </div>
       ...
       <section className="py-16">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             ...
             <div>
               <h2 className="text-3xl font-bold text-gray-900 mb-6">Bill Station Virtual Card</h2>
       ...
       <section className="py-16">
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="bg-[#2a61de] text-white rounded-2xl py-16 px-8 text-center">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
             ...
             <div>
               ...
               <div className="flex items-start space-x-4 mb-8">
                 <svg className="w-8 h-8 text-[#2a61de] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                 </svg>
                 <div>
                   <h3 className="text-lg font-bold text-gray-900 mb-2">Email Us</h3>
                   <p className="text-gray-900">admin@thebillstation.com</p>
                   <p className="text-gray-900">thebillstation175@gmail.com</p>
                 </div>
               </div>
               ...
               <div className="flex items-start space-x-4">
                 ...
                 <div>
                   <h3 className="text-lg font-bold text-gray-900 mb-2">whats app chat</h3>
                   <a href="tel:+2349168581914" className="text-[#2a61de] underline">+2349168581914</a>
                 </div>
               </div>
             </div>
             ...
             <div>
               ...
               <form className="space-y-4">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div>
                     ...
                     <input
                       ...
                       className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2a61de] focus:border-transparent"
                     />
                   </div>
                   <div>
                 ...
                 <div>
                   ...
                   <div className="relative">
                     ...
                     <input
                       type="tel"
                       placeholder="Phone"
                       className="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2a61de] focus:border-transparent"
                     />
                   </div>
                 </div>
                 <div>
                 ...
                 <Button type="submit" className="w-full bg-[#2a61de] hover:bg-[#1e4bb8] text-white py-3 rounded-lg">
                   Submit
                 </Button>
               </form>
             </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     ...
                     <div>
                       ...
                       <div className="mb-4 inline-block">
                         <div className="text-center">
                           <img src="/logo.png" alt="Bill Station Logo" className="h-12 w-auto mx-auto mb-1" />
                           <div className="text-sm">BILL STATION</div>
                         </div>
                       </div>
               ...
               <div className="flex space-x-4">
                 ...
                 {/* LinkedIn */}
                 <div className="w-10 h-10 border border-white rounded-lg flex items-center justify-center">
                   <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
             ...
             <div>
               ...
               <ul className="space-y-2">
                 <li><Link to="/landing" className="text-white underline hover:no-underline">Home</Link></li>
                 <li><Link to="/about" className="text-white underline hover:no-underline">About us</Link></li>
                 <li><Link to="/crypto" className="text-white underline hover:no-underline">Crypto</Link></li>
                 <li><Link to="/services" className="text-white underline hover:no-underline">Services</Link></li>
                 <li><Link to="/agent" className="text-white underline hover:no-underline">Become an agent</Link></li>
               </ul>
             </div>
             ...
             <div>
               <ul className="space-y-2">
                 <li><Link to="/terms" className="text-white underline hover:no-underline">Terms & conditions</Link></li>
               </ul>
             </div>
           </div>
