      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-lg font-semibold text-gray-900">Cable TV Payment</h1>
            <p className="text-xs text-gray-600">Subscribe to your favorite TV channels</p>
          </div>
          <div className="w-10" />
        </div>
      </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Choose your cable TV provider</p>
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg bg-white rounded-xl">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Smart Card Number</h3>
                    <p className="text-sm text-gray-600">Enter your decoder smart card number</p>
                  </div>
                </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Choose your subscription package</p>
                    </div>
                  </div>
