      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-lg font-semibold text-gray-900">Data Bundle</h1>
            <p className="text-xs text-gray-600">Buy internet data bundles</p>
          </div>
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium font-mono text-sm">{dataData.phoneNumber}</span>
                    </div>
                    {getSelectedBundle() && (
                      <>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Bundle</span>
                          <span className="font-medium text-sm">{getSelectedBundle()?.name} - {getSelectedBundle()?.duration}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Validity</span>
                          <span className="font-medium text-sm">{getSelectedBundle()?.validity}</span>
                        </div>
                      </>
                    )}
                    <div className="flex justify-between">
